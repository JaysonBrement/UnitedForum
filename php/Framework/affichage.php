...
public static function threadDisplayMasher($threadTable){
...
public static function postHeaderMasher($postTable){
    if(empty($postTable)){
        header('Location: /404');
        return;
    }
...
public static function postContentMasher($postTable){
    $i = 1;
...
public static function categoryMenuDisplayMasher($categoryTable){
